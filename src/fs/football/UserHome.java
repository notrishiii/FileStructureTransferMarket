...
public class UserHome extends JFrame implements ActionListener
{
	...
	Font fh=new Font("Trebuchet MS",Font.BOLD,48);
	...
	public UserHome()
	{
             Dimension dim = Toolkit.getDefaultToolkit().getScreenSize();
				...
				lbl1.setText("Transfer Market");
				lbl1.setFont(fh);
				lbl1.setForeground(Color.WHITE);
				lbl1.setHorizontalAlignment(SwingConstants.CENTER);
				
				btn.setBounds(400,195,500,50);
		...
		bb3.setFont(fl);
                bb3.addActionListener(this);
                                ...
                                wal.setIcon(new ImageIcon("C:\\Users\\RISHI\\Desktop\\FSproject\\oz.png"));
